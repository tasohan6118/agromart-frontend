...
const SellerRegister = () => {
    ...
    const text = language === 'bn'
      ? {
          ...
          login: 'লগইন',
          or: 'অথবা',
          google: 'গুগল দিয়ে রেজিস্টার করুন',
 ...
 const handleGoogleRegister = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-green-50 to-teal-100 flex items-center justify-center px-8 py-12">
       ...
       <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <p><small>{text.haveAccount}<Link className="btn btn-link" to="/seller-login">{text.login}</Link></small></p>
       </form>
